**📘 Day 2 – Decision Trees & Random Forests**
...
🔑 Key Takeaways
- Decision trees are intuitive — like asking questions step by step.
- Entropy and information gain decide the “best” question to ask at each split.
...
📊 Metrics Learned
- Entropy & Information Gain → used to build trees.
- Accuracy → measures how well the tree/forest predicts.
